...
Les symbolisations sont des éléments primitifs produits par la grammaire et
définis par les langages ordinaires (non récursifs). Les éléments en Rust
peuvent être classés dans les catégories suivantes de symbolisations :
...
* [Les identifiants][identifier]
* [Les littéraux](#les-litteraux)
* [Les durées de vie](#les-durees-de-vie-et-les-etiquettes-de-boucles)
* [Les ponctuations](#les-ponctuations)
* [Les délimitations](#delimiters)
